  ...
  return (
    <section className="dashboard-section">
      <div className="dashboard-header">
        <h2>Empowering Financial Growth with Beelinx's Innovative Solutions</h2>
        <p>
        Tailored solutions to enhance efficiency, drive innovation, and fuel business growth.
        </p>
