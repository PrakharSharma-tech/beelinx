...
const SMSDashboardSection = () => {
  return (
    <section className="dashboard-section">
      <div className="dashboard-header">
        <h2>School Management Software</h2>
        <p>
        A centralized platform designed to streamline and automate administrative, academic, and communication processes 
for schools.
        </p>
...
export default SMSDashboardSection;
