...
const ERPDashboardSection = () => {
  return (
    <section className="dashboard-section">
      <div className="dashboard-header">
        <h2>ERP Software</h2>
        <p>
        Enterprise Resource Planning (ERP) software centralizes and integrates core business processes into one unified system.
        </p>
...
export default ERPDashboardSection;
