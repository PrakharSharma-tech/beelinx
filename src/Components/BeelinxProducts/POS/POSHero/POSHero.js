...
const POSDashboardSection = () => {
  return (
    <section className="dashboard-section">
      <div className="dashboard-header">
        <h2>  Retail POS Software</h2>
        <p>
        A Point of Sale (POS) system that allows retailers to process transactions, manage inventory, and track sales 
        performance in real-time, enhancing the overall customer experience.
        </p>
...
export default POSDashboardSection;
