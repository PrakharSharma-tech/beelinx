...
const PMSDashboardSection = () => {
  return (
    <section className="dashboard-section">
      <div className="dashboard-header">
        <h2>Payin Management Software</h2>
        <p>
        A robust solution that helps businesses manage and track incoming payments efficiently, ensuring seamless collection, 
...
export default PMSDashboardSection;
