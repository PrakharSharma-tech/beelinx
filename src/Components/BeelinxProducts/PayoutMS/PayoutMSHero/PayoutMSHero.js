...
import "./PayoutMSHero.css";

const PayoutMSDashboardSection = () => {
  return (
    <section className="dashboard-section">
      <div className="dashboard-header">
        <h2> Payout Management Software</h2>
        <p>
        A powerful platform designed to manage, track, and process payments to vendors, employees, and other stakeholders 
        with efficiency, accuracy, and security.
        </p>
...
export default PayoutMSDashboardSection;
