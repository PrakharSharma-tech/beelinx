...
const CSMSDashboardSection = () => {
  return (
    <section className="dashboard-section">
      <div className="dashboard-header">
        <h2>Cooperative Society Management Software</h2>
        <p>
        A comprehensive solution designed to streamline and digitize the operations of cooperative societies.
        </p>
...
export default CSMSDashboardSection;
