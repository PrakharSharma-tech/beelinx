  ...
  return (
    <section className="dashboard-section">
      <div className="dashboard-header">
        <h2>CRM Software</h2>
        <p>
        A customer relationship management (CRM) system is designed to help businesses manage and analyze customer 
        interactions throughout the customer lifecycle, enhancing relationships and driving growth.
        </p>
