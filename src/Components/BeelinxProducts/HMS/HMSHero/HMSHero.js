...
const HMSDashboardSection = () => {
  return (
    <section className="dashboard-section">
      <div className="dashboard-header">
        <h2>Hospital Management Software</h2>
        <p>
        A centralized platform designed to streamline and automate hospital operations, enhancing patient care and 
...
export default HMSDashboardSection;
