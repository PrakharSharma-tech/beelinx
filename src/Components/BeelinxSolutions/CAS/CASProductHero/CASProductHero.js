...
import "./CASProductHero.css"

const CASProductHero = () => {
  return (
    <div>
    <div className="Beelinx-container">
      <div className="Beelinx-content">
        <h1>Custom API Solutions</h1>
        <p>
        We offer customized API solutions tailored to the unique requirements of our clients. Our team of experts collaborates closely with clients to understand their specific business objectives and design APIs that address their distinct challenges, ensuring scalability, flexibility, and future-proofing.        </p>
