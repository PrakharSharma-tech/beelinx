...
export const CustomerStories = () => {
  const stories = [
    { title: "How Window Nation's creative department leverages Beelinx's AI features", category: 'Retail', img: '/technologyfilter5.png', industry: 'Retail' },
    { title: "Walmart Canada Automates Processes & Proves Project Value With Beelinx", category: 'Retail', img: '/technologyfilter4.png', industry: 'Retail' },
    { title: "Siemens Smart Infrastructure and Beelinx: Standardizing Processes and Automating Project Delivery", category: 'Technology', img: '/siemensSmartFilter.png', industry: 'Technology' },
    ...
    { title: "BigCommerce Streamlines Systems to Scale Services", category: 'Technology', img: '/technologyfilter3.png', industry: 'Technology' },
    { title: "Synoes Builds a Workplace of the Future With Beelinx", category: 'Healthcare', img: '/technologyfilter5.png', industry: 'Healthcare' },
    { title: "How Window Nation's creative department leverages Beelinx's AI features", category: 'Retail', img: '/technologyfilter3.png', industry: 'Retail' },
    { title: "Walmart Canada Automates Processes & Proves Project Value With Beelinx", category: 'Retail', img: '/technologyfilter4.png', industry: 'Retail' },
